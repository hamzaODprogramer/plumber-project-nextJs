...
export default function ResetPassword() : React.ReactNode {
    return <div style={{backgroundImage:"url('/bg-login.mp4')"}} className="flex h-full items-center justify-center">
        <video
            autoPlay
            loop
            muted
        ...
        <div className="w-fit z-90 flex flex-col py-10 px-15 items-center h-fit bg-white shadow-md shadow-black/30">
            ...
            <p className="text-2xl font-semibold text-[#061f46] text-center">Entrer votre email pour récuperer <br/> votre compte</p>
            <Input
                type="email" 
