...
export default function ResetPassword(): React.ReactNode {
  ...
  return (
    ...
    >
      ...
      <div className="w-2/5 z-90 flex flex-col py-10 px-15 items-center h-fit bg-white shadow-md shadow-black/30">
        <Image width={160} height={160} src="/logo2.png" alt="logo" />
        <p className="text-2xl font-semibold text-[#061f46] text-center">
          {(translations[lang]['ResetPassword_Title']).split('<br/>')[0]}
        </p>
        <Input
          type="email"
          icon={<Mail size={24} className="text-[#061f46] opacity-65" />}
          placeholder={translations[lang]['ResetPassword_Email_Placeholder']}
        ...
        >
          {translations[lang]['ResetPassword_Login_Link']}
        </Link>
        <Button
          text={translations[lang]['ResetPassword_Button_Text']}
