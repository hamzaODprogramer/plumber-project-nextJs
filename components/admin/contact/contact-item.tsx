...
export default function ContactItem({icon:Icon,type,placeholder,className,fill}:ContactItemProps) : React.ReactNode {
    return <div className="bg-black/10 dark:bg-white/10 w-full p-3 flex gap-2 items-stretch">
        <div className="p-2 bg-white dark:bg-gray-800 w-fit flex items-center">
            <Icon size={27} className="text-gray-800 " fill={fill ? "#061f46" : 'white'}  />
        </div>
        <input 
            type={type}
