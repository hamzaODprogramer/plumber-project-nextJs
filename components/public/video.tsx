    ...
    <div className="mt-20 relative w-full h-[500px]">
      ...
      <div className="relative w-full h-full flex flex-col items-center justify-center">
        <div className="cursor-pointer flex flex-col items-center gap-6">
            ...
            <DialogTrigger asChild>
              <div className="relative flex items-center justify-center">
                ...
                <div className="relative z-10">
                  <Play
                    className="bg-white p-5 size-24 transition-all duration-300 hover:size-28 rounded-full"
                    color="#184d88"
                    fill="#184d88"
                  />
                </div>
          ...
          <p className="text-white mt-10 font-bold text-4xl md:text-5xl text-center">
            {translations[lang]['Video_Service_urgence']}
          </p>
          <p className="text-white mt-2 font-bold text-2xl md:text-3xl text-center">
            {translations[lang]['Video_Horaires']}
          </p>
        </div>
        <ContactForm />
      </div>
