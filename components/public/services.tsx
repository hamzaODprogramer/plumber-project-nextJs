...
export default function Services() : JSX.Element {
    ...
    return <div className="mt-12 md:mt-24 w-full flex flex-col lg:flex-row overflow-hidden">
        ...
        <div className="px-6 md:px-12 lg:ml-10 flex-1 overflow-hidden">
            <p className="text-[#ff4917] font-bold uppercase text-sm md:text-md">Nos services</p>
            ...
            <div className={`mt-8 ${isRTL && "flex gap-1"} md:mt-11 w-full`}>
                <div ref={ref} className="keen-slider">
                    <div className="keen-slider__slide">
                        <ServiceCard icon={<Toilet className="p-4 border-5 border-white" size={74} fill='#184d88' color="#184d88" />} />
                    </div>
                    <div className="keen-slider__slide">
                        <ServiceCard icon={<Droplet className="p-4 border-5 border-white" size={74} fill='#184d88' color="#184d88" />} />
                    </div>
                    <div className="keen-slider__slide">
                        <ServiceCard icon={<Waves className="p-4 border-5 border-white" size={74} fill='#184d88' color="#184d88" />} />
                    </div>
                    <div className="keen-slider__slide">
                        <ServiceCard icon={<ShowerHead className="p-4 border-5 border-white" size={74} fill='#184d88' color="#184d88" />} />
                    </div>
                </div>
            </div>
        </div>
